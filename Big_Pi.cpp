...
const int MAX_ITERATIONS = 12;				//number of iterations for 1 million digits of Pi
...
/*
* print
*This function uses mpf_get_str function of MPIR library and converts value of pi to char
* and it iterates the char and prints the output in desired format.
*/
void print(const mpf_t& pi)
{
